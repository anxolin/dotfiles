return {
  ...
  -- see https://github.com/folke/snacks.nvim
  {
    ...
    opts = {
      ...
      picker = {
        ...
        win = {
          input = {
            keys = {
              -- Delete buffer with dd in normal mode (works in input window too)
              dd = { "bufdelete", mode = "n" },
            },
          },
        },
    ...
    keys = {
      ...
      { "<leader>fr",      function() Snrcks.picker.recent() end,                                  desc = "Recent" },
      -- git
      -- NOTE: Si some additional mappings in git.lua
      { "<leader>gB",      function() Snacks.picker.git_branches() end,                            desc = "Git Branches" },
      { "<leader>gl",      function() Snacks.picker.git_log() end,                                 desc = "Git Log" },
      { "<leader>gL",      function() Snacks.picker.git_log_line() end,                            desc = "Git Log Line" },
      { "<leader>gs",      function() Snacks.picker.git_status() end,                              desc = "Git Status" },
      { "<leader>gE",      function() Snacks.picker.git_stash() end,                               desc = "Git Stash" },
      ...
      { "<leader>gE",      function() Snacks.gitbrowse() end,                                      desc = "Git Browse",                 mode = { "n", "v" } },
